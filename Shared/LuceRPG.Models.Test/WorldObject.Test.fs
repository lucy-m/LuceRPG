...
module WorldObject =
    ...
    module getPoints =
        ...
        module ``1x1 object`` =
            ...
            let obj = WorldObject.create (WorldObject.Type.Path (1,1)) topLeft |> TestUtil.withGuid
        ...
        module ``2x2 object`` =
            ...
            let obj = WorldObject.create WorldObject.Type.Wall topLeft |> TestUtil.withGuid
